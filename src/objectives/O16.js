function objective(){
    return (
        <div id="content">
            ...
            <div>
                <div id="contentTitle">
                    <h1>16 - Pace, Giustizia e Istituzioni Solide</h1>
                </div>
                <div id="contentText">
                    ...
                    <table>
                        <tr>
                            <td>corruzione</td>
                            <td>magistratura e polizia ne sono affette per la maggior parte</td>
                        </tr>
                        <tr>
                            <td>corruzione, concussione, furto ed evasione fiscale</td>
                            <td>costano circa 1,26 mila miliardi di dollari l'anno. Questa somma potrebbe essere usata per risollevare coloro che vivono in povertà</td>
                        </tr>
                        <tr>
                            <td>bambini e scuola</td>
                            <td>la percentuale di coloro che lasciano la scuola ha raggiunto il 50% nel 2011, comprendendo 28,5 milioni di bambini</td>
                        </tr>
                        <tr>
                            <td>stato di diritto e di sviluppo</td>
                            <td>caratterizzati da una significativa interrelazione e si rafforzano a vicenda</td>
                        </tr>
                    </table>
                    <h3>-Traguardi:</h3>
                    <ul>
                        <li>1) Ridurre significativamente in ogni dove tutte le forme di violenza e i tassi di mortalità connessi</li>
                        <li>2) Eliminare l’abuso, lo sfruttamento, il traffico e tutte le forme di violenza e tortura contro i bambini</li>
                        <li>3) Promuovere lo stato di diritto a livello nazionale e internazionale e garantire parità di accesso alla giustizia per tutti</li>
                        <li>4) Entro il 2030, ridurre in modo significativo i flussi finanziari e di armi illeciti, rafforzare il recupero e la restituzione dei beni rubati e combattere tutte le forme di criminalità organizzata</li>
                        <li>5) Ridurre sostanzialmente la corruzione e la concussione in tutte le loro forme</li>
                        <li>6) Sviluppare istituzioni efficaci, responsabili e trasparenti a tutti i livelli</li>
                        <li>7) Assicurare un processo decisionale reattivo, inclusivo, partecipativo e rappresentativo a tutti i livelli.</li>
                        <li>8) Allargare e rafforzare la partecipazione dei Paesi in via di sviluppo nelle istituzioni della governance globale</li>
                        <li>9) Entro il 2030, fornire l’identità giuridica per tutti, compresa la registrazione delle nascite</li>
                        <li>10) Garantire l’accesso del pubblico alle informazioni e proteggere le libertà fondamentali, in conformità con la legislazione nazionale e con gli accordi internazionali</li>
                        <li>a) Rafforzare le istituzioni nazionali, anche attraverso la cooperazione internazionale, per costruire maggiore capacità a tutti i livelli, in particolare nei Paesi in via di sviluppo, per prevenire la violenza e combattere il terrorismo e la criminalità</li>
                        <li>b) Promuovere e far rispettare le leggi e le politiche non discriminatorie per lo sviluppo sostenibile</li>
                    </ul>
