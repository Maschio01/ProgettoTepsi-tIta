function objective(){
    return (
        <div id="content">
            ...
            <div>
                <div id="contentTitle">
                    <h1>9 - Costruire un'infrastruttura resiliente e promuovere un industrializzazione sostenibile</h1>
                </div>
                <div id="contentText">
                    ...
                    <table>
                        <tr>
                            <td>persone nei paesi in sviluppo senza accesso continuo all'elettricità</td>
                            <td>2.6 miliardi di persone</td>
                        </tr>
                        <tr>
                            <td>persone senza accesso a servizi sanitari</td>
                            <td>2.5 miliardi di persone</td>
                        </tr> 
                        <tr>
                            <td>persone senza accesso all'acqua</td>
                            <td>800 milioni di persone</td>
                        </tr>
                        <tr>
                            <td>persone senza servizi di telefonia affidabili</td>
                            <td>1 / 1.5 miliardi di persone</td>
                        </tr>
                        <tr>
                            <td>posti lavoro forniti dall'industria manifatturiera</td>
                            <td>470 milioni di impieghi</td>
                        </tr>
                        <tr>
                            <td>posti lavorocreati per ogni impiego nell'industria manifatturiera</td>
                            <td>2.2 impieghi negli altri settori</td>
                        </tr>
                        <tr>
                            <td>imprese manifatturiere</td>
                            <td>90% delle imprese a livello mondiale</td>
                        </tr>
                        
                    </table>
                    <h3>-Traguardi:</h3>
                    <ul>
                        <li>1) Sviluppare infrastrutture di qualità, affidabili, sostenibili e resilienti, con particolare attenzione ad un accesso equo e conveniente per tutti</li>
                        <li>2) Promuovere un’industrializzazione inclusiva e sostenibile e aumentare l’occupazione nell’industria e il prodotto interno lordo (raddoppiare la quota nei paesi meno sviluppati)</li>
                        <li>3) Incrementare l’accesso delle piccole e medie imprese ai servizi finanziari e la loro integrazione nell’indotto e nei mercati </li>
                        <li>4) Migliorare le infrastrutture e riconfigurare in modo sostenibile le industrie, aumentando l’efficienza e adottando tecnologie più sane per l’ambiente</li>
                        <li>5) Aumentare la ricerca scientifica, migliorare le capacità tecnologiche, incoraggiare le innovazioni e incrementare considerevolmente la quota di impiegati nel settore della ricerca e dello sviluppo e la spesa per la ricerca e per lo sviluppo</li>
                        <li>a) Facilitare la formazione di infrastrutture sostenibili e resilienti negli stati in via di sviluppo tramite un supporto finanziario, tecnico e tecnologico rinforzato</li>
                        <li>b) Supportare lo sviluppo tecnologico interno, la ricerca e l’innovazione nei paesi in via di sviluppo </li>
                        <li>c) Aumentare in modo significativo l’accesso alle tecnologie di informazione e comunicazione e fornire ai Paesi meno sviluppati un accesso a Internet universale ed economico </li>
                    </ul>
