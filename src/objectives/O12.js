function objective(){
    return (
        <div id="content">
            ...
            <div>
                <div id="contentTitle">
                    <h1>12 - Modelli sostenibili di produzione e consumo</h1>
                </div>
                <div id="contentText">
                    ...
                    <p>Lo scenario legato ai modelli di produzione e consumo responsabili, infatti, si completa con il cosiddetto water stress (il prelievo eccessivo delle riserve naturali di acqua rispetto alla loro reale disponibilità) e il diseguale accesso dell’acqua potabile. Coinvolge inoltre altri fattori che comportano degrado ambientale e disuguaglianza sociale: l’ancora alto utilizzo di energia da fonti fossili, il lento sviluppo delle forme di energia rinnovabile, l’eccessivo sfruttamento del suolo e la conseguente perdita di fertilità dei terreni agricoli.</p>
                    <h3>-Fatti e Cifre:</h3>
                    <table>
                        <tr>
                            <td>cibo annuale buttato nella spazzatura</td>
                            <td>1/3 del cibo prodotto</td>
                        </tr>
                        <tr>
                            <td>soldi risparmiati se ognuno usasse lampadine a risparmio energetico</td>
                            <td>120 miliardi di dollari l'anno</td>
                        </tr>
                        <tr>
                            <td>acqua potabile nel mondo</td>
                            <td>meno del 3%</td>
                        </tr>
                        <tr>
                            <td>acqua potabile nel mondo congelata in Antartide</td>
                            <td>2.5%</td>
                        </tr>
                        <tr>
                            <td>persone senza accesso all'acqua potabile</td>
                            <td>più di un miliardo di persone</td>
                        </tr>
                        <tr>
                            <td>stock automobilistico nel 2002</td>
                            <td>550 milioni di veicoli</td>
                        </tr>
                        <tr>
                            <td>stock automobilistico entro il 2020</td>
                            <td>incremento dle 32% dei veicoli</td>
                        </tr>
                        <tr>
                            <td>energia globale consumata dalle famiglie</td>
                            <td>29% dell'energia</td>
                        </tr>
                        <tr>
                            <td>persone che soffrono di denutrizione</td>
                            <td>quasi 1 miliardo</td>
                        </tr>
                        <tr>
                            <td>cibo che va sprecato ogni anno</td>
                            <td>1.3 miliardi di tonellate di cibo</td>
                        </tr>
                        <tr>
                            <td>persone in sovrappeso o obese</td>
                            <td>2 miliardi di persone</td>
                        </tr>
                        <tr>
                            <td>consumo dell'energia rappresentato dal settore alimentare</td>
                            <td>30% del consumo</td>
                        </tr>
                        <tr>
                            <td>gas serra emessi dal settore alimentare</td>
                            <td>22% del totale</td>
                        </tr>
                    </table>
                    <h3>-Traguardi:</h3>
                    <ul>
                        <li>1) Dare attuazione al quadro decennale di programmi sul consumo e la produzione sostenibile </li>
                        <li>2) Raggiungere la gestione sostenibile e l’uso efficiente delle risorse naturali</li>
                        <li>3) Dimezzare lo spreco pro capite globale di rifiuti alimentari e ridurre le perdite di cibo nella produzione</li>
                        <li>4) Entro il 2020, ottenere la gestione ecocompatibile di sostanze chimiche e di tutti i rifiuti; ridurre il loro rilascio in aria, acqua e suolo, per minimizzare gli effetti negativi su salute e ambiente</li>
                        <li>5) Ridurre in modo sostanziale la produzione di rifiuti attraverso la prevenzione, la riduzione, il riciclaggio e il riutilizzo</li>
                        <li>6) Incoraggiare le imprese ad adottare pratiche sostenibili e integrare le informazioni sulla sostenibilità nelle loro relazioni periodiche</li>
                        <li>7) Promuovere pratiche in materia di appalti pubblici che siano sostenibili</li>
                        <li>8) Fare in modo che in tutto il mondo tutti abbiano le informazioni rilevanti in tema di sviluppo sostenibile e stili di vita in armonia con la natura</li>
                        <li>a) Sostenere i paesi in via di sviluppo a rafforzare la loro capacità scientifica e tecnologica per andare verso modelli più sostenibili di consumo e di produzione</li>
                        <li>b) Sviluppare e applicare strumenti per monitorare gli impatti di sviluppo sostenibile per il turismo sostenibile, che crei posti di lavoro e promuova la cultura e i prodotti locali</li>
                        <li>c) Razionalizzare i sussidi ai combustibili fossili che incoraggiano lo spreco, tenendo conto delle esigenze specifiche e delle condizioni dei paesi in via di sviluppo e riducendo al minimo gli effetti negativi sul loro sviluppo per proteggere le comunità povere</li>
                    </ul>
